...
export default {
  ...
  language: 'html',
  narrator: 'The Tomb is a collapsed archive, its very bones malformed. Scratched by the entrance in a confident hand: "the corruption\'s just bad code. don\'t panic. — M" Your sister was here. The Broken-Markup Wraith flickers because its skeleton is broken. Fix the structure — snap its bones into place.',
  ...
  completion: {
    entryLabel: 'Gate 01 — Cleared',
    icon: '📡',
    chip: 'GATE CLEARED',
    heading: 'The Gate opens.',
    body: 'Most seekers left thinking it was dead. You stayed. The browser forgives everything. <strong>The Gate does not.</strong> You extracted what others dismissed as worthless.',
    rewards: [
      { label: '$SHARD EARNED', value: '+250' },
      { label: 'XP GAINED', value: '+100' },
      { label: 'FRAGMENT', value: 'Signal Fragment' },
      { label: 'RANK', value: 'E License' },
    ],
