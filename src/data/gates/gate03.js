...
export default {
  ...
  rank: 'D',
  region: 'THE FOUNDRY · BOSS HUNT',
  questId: 'act1-ch03',
  nextGate: 'interlude2',
  ability: 'FORM FORGE',
  language: 'html',
  narrator: 'VERA, before the door: "That\'s not a mob. That\'s a D-rank boss, and you\'re an E. The Association would tell you to wait — the Association isn\'t down here." Mara\'s carving, shorter and faster this time: "boss. feed it labels. go." The Label Eater devours any unlabeled input — bare fields HEAL it. You\'ve seen an unkillable health bar before. This one has a rule. Learn it. Starve it.',
  ...
  completion: {
    entryLabel: 'Label Eater — Slain',
    icon: '⚗️',
    chip: 'RANK D — LICENSED',
    heading: 'Promotion, Hunter.',
    body: 'An E-rank soloing a D-rank boss on their third dive. It starved because every field had identity — <strong>you found the rule behind an unkillable bar and broke it.</strong> The Board is going to think VERA falsified the logs. One stratum witnessed. Nine to go.',
    rewards: [
      { label: '$SHARD PAYOUT', value: '+700' },
      { label: 'XP LOGGED', value: '+300' },
      { label: 'BOSS CORE', value: 'Label Eater Core' },
      { label: 'RANK', value: 'D — PROMOTED' },
    ],
