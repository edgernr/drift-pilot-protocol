      ...
      <div className="panel panel-glow" style={{ padding: '40px 36px' }}>
        ...
        <div style={{ color: 'var(--ink-1)', fontSize: 15, lineHeight: 1.7 }}>
          <p style={{ marginBottom: 20 }}>
            These Terms of Service ("Terms") govern your use of Drift Pilot Protocol and the Drift
            Builders Academy (together, the "Service"), a gamified coding education platform operated
            by the Drift Pilot Protocol team ("we", "us"). By creating an account or using the Service
          ...
          <Section n="2" title="Eligibility &amp; Age Requirements">
            <p>
              Drift Pilot Protocol (the main academy) is intended for users aged 16 and older. If you
            ...
            <p style={{ marginTop: 12 }}>
              <strong>Drift Builders Academy (ages 8–16):</strong> The Academy is designed for minors.
          ...
          <Section n="3" title="Description of the Service">
            <p>
              The Service is a gamified coding academy. Drift Pilot Protocol teaches modern frontend
              development (HTML, CSS, JavaScript, TypeScript, React and related topics) through quests,
              "gates", XP, levels, leaderboards, and in-app rewards. Drift Builders Academy teaches
          ...
          <Section n="6" title="$DRIFT — In-App Reward Only">
            <p>
              <strong>$DRIFT is an in-app reward used within the Service.</strong> It represents
            ...
            <ul style={{ margin: '10px 0 0', paddingLeft: 22 }}>
              <li><strong>$DRIFT has no guaranteed monetary value.</strong> We make no promise that it can be redeemed, exchanged, sold, or converted into fiat currency or any other asset.</li>
              <li>$DRIFT is <strong>not</strong> a security, investment, share, or financial instrument, and is <strong>not</strong> intended to be one.</li>
              ...
              <li>We may adjust, cap, expire, or discontinue $DRIFT balances, earn rates, and mechanics at any time, including for Phase-1 launch.</li>
            </ul>
          </Section>
          ...
          <Section n="8" title="Termination &amp; Bans">
            <p>
              ...
              including $DRIFT, may be forfeited.
            </p>
          </Section>
